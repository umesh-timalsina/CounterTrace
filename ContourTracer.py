...
class ContourTracer(object):
    ...
    def __init__(self, image_path):
        ...
        plt.imshow(self.tess, origin='lower')
#        plt.show()
        pass
    ...
    def find_boundary(self,start):
        ...
        #        if self.tess[j-1,i-1] != self.tess[j,i]:
        #            if self.tess[j-1,i-1] == intense and (j-1,i-1) not in B:
        #                B.append((i-1,j-1))
        #            if self.tess[j,i] == intense and (j,i) not in B:
        #                B.append((i,j))
    ...
    def count_lines(self,arr):
        ...
        while len(arr) != 0:
            ...
            i = 0
            for l in arr:
                if(l[0] == 0 or l[1] == 0 or l[0] == self.image_dims[0]-1 or l[1] == self.image_dims[0]-1 or l[0] == self.image_dims[1]-1 or l[1] == self.image_dims[1]-1):
                    st = l
                    break
                else:
                    st = l
